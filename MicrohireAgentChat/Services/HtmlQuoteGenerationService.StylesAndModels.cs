...
public partial class HtmlQuoteGenerationService
{
    private string GetStyles()
    {
        ...
        :root {
            ...
            --bg-light: #f5f5f5;
            --white: #ffffff;
            /* System stack avoids Google Fonts + NetworkIdle hangs in headless PDF on Azure */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cover-logo-text { font-family: var(--font-heading); font-weight: 800; font-size: 48px; color: var(--white); letter-spacing: 2px; }
        .cover-logo-text span { color: var(--white); font-weight: 300; }
        .cover-tagline { font-family: var(--font-heading); font-size: 11px; color: var(--white); letter-spacing: 4px; text-transform: uppercase; opacity: 0.9; }
        .cover-title { position: relative; z-index: 10; margin-top: auto; padding-bottom: 40px; }
        .cover-title h1 { font-family: var(--font-heading); font-weight: 300; font-size: clamp(32px, 5vw, 52px); color: var(--white); line-height: 1.2; }
        .cover-footer { background: var(--white); padding: 30px 40px; display: flex; justify-content: space-between; align-items: flex-end; }
        .cover-date { font-family: var(--font-heading); font-weight: 600; font-size: 18px; color: var(--microhire-red); }
        .cover-ref { font-family: var(--font-heading); font-weight: 500; font-size: 14px; color: var(--microhire-red); margin-top: 5px; }
        .cover-venue-logo { text-align: right; }
        .venue-name { font-family: var(--font-heading); font-weight: 700; font-size: 20px; color: var(--text-dark); letter-spacing: 2px; }
        .venue-location { font-family: var(--font-heading); font-size: 11px; color: var(--text-gray); letter-spacing: 3px; text-transform: uppercase; }
        ...
        .page-section-title { font-family: var(--font-heading); font-weight: 700; font-size: 14px; color: var(--microhire-red-darker); letter-spacing: 1px; margin-bottom: 8px; }
        .page-event-title { font-family: var(--font-heading); font-weight: 700; font-size: clamp(18px, 3vw, 24px); color: var(--microhire-red); display: flex; align-items: center; gap: 12px; }
        ...
        .detail-label { font-family: var(--font-heading); font-weight: 600; font-size: 11px; color: var(--microhire-red); text-transform: uppercase; letter-spacing: 0.5px; width: 180px; flex-shrink: 0; }
        ...
        .schedule-label { font-family: var(--font-heading); font-weight: 600; font-size: 11px; color: var(--microhire-red); text-transform: uppercase; width: 130px; flex-shrink: 0; }
        ...
        .footer-logo-icon::after { content: 'M'; color: white; font-family: var(--font-heading); font-weight: 800; font-size: 16px; }
        ...
        .equipment-header-desc { font-family: var(--font-heading); font-weight: 600; font-size: 12px; color: var(--microhire-red); flex: 1; }
        .equipment-header-qty { font-family: var(--font-heading); font-weight: 600; font-size: 12px; color: var(--microhire-red); width: 80px; text-align: center; }
        ...
        .section-total-label { font-family: var(--font-heading); font-weight: 600; font-size: 13px; color: var(--text-dark); margin-right: 30px; }
        .section-total-amount { font-family: var(--font-heading); font-weight: 700; font-size: 14px; color: var(--text-dark); }

        /* Labour/Technical Services Page */
        .labour-table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
        .labour-table th { font-family: var(--font-heading); font-weight: 600; font-size: 11px; color: var(--microhire-red); text-transform: uppercase; text-align: left; padding: 10px 8px; border-bottom: 2px solid var(--microhire-red); }
        ...
        .manager-name { font-family: var(--font-heading); font-weight: 700; font-size: 16px; color: var(--text-dark); margin-bottom: 5px; }
        ...
        .payment-title { font-family: var(--font-heading); font-weight: 700; font-size: 12px; color: var(--microhire-red); text-transform: uppercase; margin-bottom: 15px; }
        .confirmation-row { display: flex; margin-bottom: 10px; }
        .confirmation-label { font-family: var(--font-heading); font-weight: 600; font-size: 11px; color: var(--microhire-red); text-transform: uppercase; width: 150px; }
        ...
        .signature-field label { font-family: var(--font-heading); font-weight: 600; font-size: 11px; color: var(--text-gray); text-transform: uppercase; display: block; margin-bottom: 8px; }
