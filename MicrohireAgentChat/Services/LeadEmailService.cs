...
<body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;"">
  <p>Hi {firstName},</p>
  <p>We have been notified of your interest in AV Services for an event you plan to host at {venue}. The details you've shared have been used to commence a quote for you. We need a little more information in order for this quote to be finalised.</p>
