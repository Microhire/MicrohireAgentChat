...
public sealed class LeadEmailService : ILeadEmailService
{
    ...
    private static string BuildHtmlBody(WestinLead lead, string chatLink)
    {
        ...
        var room = System.Net.WebUtility.HtmlEncode(lead.Room);
...
<body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;"">
  <p>Hi {firstName},</p>
  <p>Thanks for your interest in hosting your event at {venue}. Your sales contact has shared your event details with us.</p>
  <p>Click the button below to continue your quote with Isla, our AI assistant. Your details are already saved so you can pick up where you left off.</p>
  <p style=""margin: 30px 0;"">
    <a href=""{chatLink}"" style=""display: inline-block; padding: 14px 28px; background-color: #ca1a20; color: white; text-decoration: none; border-radius: 8px; font-weight: 600;"">Get Your Quote</a>
  </p>
  <p style=""font-size: 14px; color: #666;"">Event: {room} at {venue}</p>
  <p style=""font-size: 12px; color: #999;"">If the button doesn't work, copy and paste this link into your browser:<br>{chatLink}</p>
  <p>Best regards,<br>The Microhire Team</p>
</body>
</html>";
    }
}
